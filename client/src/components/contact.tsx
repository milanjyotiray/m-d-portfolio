  ...
  const contactInfo = [
    {
      icon: FaEnvelope,
      title: "Email",
      info: "mdfreelance25@gmail.com",
      gradient: "from-blue-primary to-blue-secondary"
    },
    {
      icon: FaPhone,
      title: "Phone",
      info: "+91 9678165375 / +91 7099621713",
          ...
          >
            ...
            >
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://www.instagram.com/mdfreelance2025/" className="w-10 h-10 bg-dark-tertiary rounded-lg flex items-center justify-center hover:bg-pink-600 transition-colors">
                  <FaInstagram />
                </a>
              </div>
            </motion.div>
